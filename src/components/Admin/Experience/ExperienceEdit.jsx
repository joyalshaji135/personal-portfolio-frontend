...
const ExperienceEdit = () => {
  ...
  const { currentExperience, isLoading, isSubmitting, error, getById, update, clearError, clearSuccess, success } = useExperience();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLocalError(err || 'Failed to update experience. Please try again.');
    }
  };
