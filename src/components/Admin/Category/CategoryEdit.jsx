...
const CategoryEdit = () => {
  ...
  const { currentCategory, isLoading, isSubmitting, error, getById, update, clearError, clearSuccess, success } = useCategory();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLocalError(err || 'Failed to update category. Please try again.');
    }
  };
