...
const RoleEdit = () => {
  ...
  const { currentRole, isLoading, isSubmitting, error, getById, update, clearError, clearSuccess, success } = useRole();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLocalError(err || 'Failed to update role. Please try again.');
    }
  };
