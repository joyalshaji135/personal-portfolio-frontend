...
const ContactEdit = () => {
  ...
  const { currentContact, isLoading, isSubmitting, error, getById, update, clearError, clearSuccess, success } = useContact();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLocalError(err || 'Failed to update contact. Please try again.');
    }
  };
