...
const EducationEdit = () => {
  ...
  const { currentEducation, isLoading, isSubmitting, error, getById, update, clearError, clearSuccess, success } = useEducation();
  ...
  useEffect(() => {
    if (currentEducation && currentEducation._id === id) {
      setFormData({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLocalError(err || 'Failed to update education entry. Please try again.');
    }
  };
